...
void Scene::CreateTestScene()
{
    ...
    //longCube->transform = Transform(Vector3f(2, 0, 3), Vector3f(0, 0, 0), Vector3f(3, 6, 3));
    ...
    //shortCube->transform = Transform(Vector3f(-2, -1, 0.75), Vector3f(0, 0, 0), Vector3f(3, 3, 3));
